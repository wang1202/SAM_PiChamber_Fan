...
!MO No ice collisions in ISDAC intercomparison basic run
!MO         if(g2_1(kr).gt.1.e-10)icol_column=1
!MO         if(g2_2(kr).gt.1.e-10)icol_plate=1
!MO         if(g2_3(kr).gt.1.e-10)icol_dendrite=1
!MO         if(g3(kr).gt.1.e-10)icol_snow=1
!MO         if(g4(kr).gt.1.e-10)icol_graupel=1
!MO         if(g5(kr).gt.1.e-10)icol_hail=1
