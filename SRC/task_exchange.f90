...
!  Also changed task_dispatch.f90 and task_assing_bnd.f90
! 
!	mask=id*100000+i1*10000+i2*1000+j1*100+j2*10    ! base 10
!	mask=id*15625+i1*3125+i2*625+j1*125+j2*25       ! base 5
	mask=id*4096+i1*1024+i2*256+j1*64+j2*16        ! base 4 (WON'T work with UM5 advection)
