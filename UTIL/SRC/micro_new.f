...
c
	...
	err = NF_DEF_DIM(ncid, 'bin', ncn, binid)
	...
	err = NF_PUT_ATT_TEXT(ncid,varid,'units',2,'mb')
        ...
        err = NF_DEF_VAR(ncid, 'CCN', NF_DOUBLE, 1, binid,varid)
	err = NF_PUT_ATT_TEXT(ncid,varid,'units',1,'-')
        err = NF_PUT_ATT_TEXT(ncid,varid,'long_name',8,'CCNSpect')
        err = NF_DEF_VAR(ncid, 'Drop', NF_DOUBLE, 1, binid,varid)
	err = NF_PUT_ATT_TEXT(ncid,varid,'units',1,'-')
	...
	err = NF_INQ_VARID(ncid,'CCN',varid)
	err = NF_PUT_VAR_DOUBLE(ncid, varid, rccn)
	err = NF_INQ_VARID(ncid,'Drop',varid)
